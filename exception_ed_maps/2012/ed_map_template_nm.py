...
statewide_school_district = d_dict['special_1_school_district']
...
ed_map.update(dict([('{state} Public Education Commission District {number}'.format(state=state[0], number=(numberclean(n))).lower(),{'name':n,'type':'special_1_school_district'}) for n in statewide_school_district]))
